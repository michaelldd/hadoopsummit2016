...
CREATE EXTERNAL TABLE test1(id INT, name STRING,
 ...
 LOCATION 'hdfs:/user/root/DB/test1';
...
create external table alerts ( id int , msg string )
     clustered by (id) into 5 buckets
     stored as orc tblproperties("transactional"="true")
LOCATION 'hdfs:/user/root/DB/test1';
     ;
...
storm jar hadoopsummit2016-0.0.1-SNAPSHOT.jar com.hortonworks.ZeroDowntimeDeployment.HiveTopology thrift://rm-wwang.cloud.hortonworks.com:9083 default test1 test1topology
*/
